...
const iconVariants = {
  hidden: { pathLength: 0, opacity: 0 }, // Hidden state: path length is 0, opacity is 0
  visible: { pathLength: 1, opacity: 1 }, // Visible state: path length is 1, opacity is 1
};
...
function DarkModeToggle() {
  ...
  // Toggle dark mode class on the document root when dark mode state changes
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      >
        {darkMode ? ( //If dark mode is true, render the dark mode path
          <motion.path
